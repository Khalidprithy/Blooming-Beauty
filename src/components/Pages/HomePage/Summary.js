    ...
    return (
        <div className='mb-20'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 m-4'>
                <div className='border-2 rounded-xl p-4 transition ease-in-out delay-250 hover:-translate-y-1 hover:scale-105 hover:bg-green-700 hover:text-white duration-300'>
