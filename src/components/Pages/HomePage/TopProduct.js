        ...
        <div className='flex flex-col md:flex-row m-2 gap-3 py-14'>
            <div className='w-full md:w-3/5 border-2 rounded-xl'>
                ...
                <div className='m-2'>
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-2'>
                        <div class="card card-compact bg-base-100 shadow-xl hover:shadow-none">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-actions justify-center">
                                    <button class="btn btn-sm btn-accent w-full">Buy Now</button>
                                </div>
                            </div>
                        </div>
                        <div class="card card-compact bg-base-100 shadow-xl hover:shadow-none">
            ...
            <div className='w-full md:w-2/5'>
                ...
                <div className='grid grid-cols-1 gap-2 border-2 rounded-2xl p-2'>
                    <div class="card h-48 card-side bg-base-100 border hover:shadow-2xl">
