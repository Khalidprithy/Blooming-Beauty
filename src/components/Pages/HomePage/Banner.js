    ...
    return (
        <div className='p-2 py-14 bg-bgpink'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-4 m-2'>
                ...
                <div className='border-2 rounded-lg p-6 transition ease-in-out delay-250 hover:-translate-y-1 hover:scale-110 hover:bg-accent hover:text-white duration-300'>
