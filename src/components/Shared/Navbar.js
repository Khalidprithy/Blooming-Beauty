...
const Navbar = () => {
    ...
    const menuItems = <>
        <li className='font-semibold text-gray-600'><Link to='/'>Dashboard</Link></li>
        <li className='font-semibold text-gray-600'><Link to='/inventory'>Inventory</Link></li>
        <li className='font-semibold text-gray-600'><Link to='/blog'>Blog</Link></li>
    </>
        ...
        <div>
            <div className="navbar bg-neutral">
                <div className="navbar-start flex-1">
                    ...
                    <Link to='/' className="btn btn-ghost normal-case text-xl text-secondary">Blooming Beauty</Link>
                </div>
